...
public class RedisConstants {
    ...
    public static final String LOCK_VOUCHER_KEY = "lock:voucher:shop:";

    public static final Long CACHE_VOUCHER_TTL = 30L;

    public static final String HOT_VOUCHER_SHOP_KEY = "hot:voucher:shop";
    ...
    public static final String ORDER_PAY_MARK_KEY = "order:pay:mark:";

    public static final Long ORDER_PAY_MARK_TTL = 2L;
}
